    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-6">
                        <h5>Date: {{ $reservation->displayDate() }}</h5>
                    </div>
                    <div class="col-6">
                        <h5 class="pull-right">Numéro de facture: {{ $reservation->invoice_number }}</h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-6">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>{{ $reservation->booking_fees }}$
                                - {{ $reservation->booking_fees_paid ? 'Payé' : 'Non-payé' }}</td>
                        </tr>
                        <tr>
                            <td>Prix</td>
                        ...
                        <tr style="border-collapse: collapse; border-top: 1px solid black;">
                            ...
                            <td>{{ $reservation->security_deposit }}$
                                - {{ $reservation->security_deposit_paid ? 'Payé' : 'Non-payé' }}</td>
                        </tr>
                        <tr>

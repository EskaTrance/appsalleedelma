                    ...
                    <div class="row">
                        <div class=" col-12 col-md-8 col-lg-6">
                            ...
                            @if ($reservation->repeating_reservation_id)
                                <button class="btn btn-danger pull-right" style="color:#fff" type="button"  data-toggle="modal" data-target="#modalDeleteRepeating">Supprimer les réservations récurrente</button>
                            @endif
                        </div>
                    </div>
                </form>

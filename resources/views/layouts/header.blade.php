<div class="header">
    ...
    <div class="">
        <div class="brand inline   m-l-10">
            <img src="{{ asset('images/logo.png') }}" alt="logo" data-src="{{ asset('images/logo.png') }}" height="60">
        </div>
        ...
        <ul class="d-lg-inline-block d-none notification-list no-margin d-lg-inline-block b-grey b-l b-r no-style p-l-20 p-r-20">
            <li class="p-r-5 inline">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu notification-toggle" style="display:none;" role="menu" aria-labelledby="notification-center">
                        <!-- START Notification -->
